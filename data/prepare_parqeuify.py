...
"""
#slap it in a folder named after current project
local_dir = args.projectname
...
if __name__ == '__main__':
    ...
    #this is the specific point in control flow we want to get rid of
    tset = load_dataset("parquet", split='train', data_dir=os.path.dirname(__file__), data_files={'train':args.trainfile}, num_proc=nprocs)
    vset = load_dataset("parquet", split='val', data_dir=os.path.dirname(__file__), data_files={'val':args.valfile}, num_proc=nprocs)
